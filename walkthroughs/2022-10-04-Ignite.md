...
I try and login with the admin/admin we saw and it works:
...
I run a `searchsploit fuel` to see what's out there and find 3 RCE exploits for this version of the CMS:
...
I run `searchsploit -m 47138` to get the exploit over to my current directory and when looking through the code it's Python 2, of course. I try the 49487 and 50477 exploits and don't have any luck with them so I just end up editing the code in 47138 to get it to work with Python 3.
...
Make sure you modify the code above and change the IP address in the xxxx variable to your own IP, and the url variable to the IP of your THM instance before running this Python script.
...
I look around the /var/www/html directory and find a .php file with SQL credentials in it. Note, this file was also mentioned on the main CMS webpage when we first visited under step 2:
