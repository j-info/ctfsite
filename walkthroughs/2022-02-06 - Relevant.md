...
Opening the link displayed there covers many methods for escalating privileges and the one I was able to get working was **PrintSpoofer**.
...
- Uploading a reverse shell to a SMB share that is web facing and then triggering it by accessing it with a browser
