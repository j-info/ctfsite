...
That gives us the answer to our first objective: **File extension after non login?**
...
This now looks like **base64** to me so I decode those as well into:
...
Interesting. Something tells me basted on this and also the robots.txt file the creater of this CTF is trolling people but we'll see if this works as a login somewhere else.
...
I try and look at the files inside of the two users on the system, **basterd** and **stoner** with no luck due to permissions.
